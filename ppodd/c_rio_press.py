...
class c_rio_press(fort_cal):
    def __init__(self,dataset):
        ...
        self.outputs=[parameter('CAB_PRES-rio',units='hPa',frequency=1,number=579,long_name='Cabin pressure')
                     ,parameter('P9_STAT-rio',units='hPa',frequency=32,number=778,long_name='Static pressure from S9 fuselage ports')]
        self.name='RIO_PRESS'
