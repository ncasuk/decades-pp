...
-----------------------------------------------------------------------------
 ...
 DESCRIPTION      Converts rawdata input from the Heimann radiometer and
 ...
 CHANGES
 DESCRIPTION      Converts the two input parameters 141 (raw Heimann) and
 ...
 ARGUMENTS        IRAW(f,141)   Raw Heimann data
 ...
 SUBPROGRAMS      ITSTFLG  -  Returns the value of bits 16 & 17    - SCILIB
         ...
         C_HEIMAN_LTST_BB  -  Checks array elemenets are within
                              +/- 86                                - LOCAL
 ...
 CHANGES          V1.01  10/02/99  W.D.N.JACKSON
...
"""
    def __init__(self,dataset):
        ...
        self.outputs=[parameter('BTHEIM_U',units='degK',frequency=4,number=537,long_name='Uncorrected brightness temperature from the Heimann radiometer',standard_name='brightness_temperature')]
        #self.name='HEIMAN'
        self.version=1.00
