"""
**pod** is the package containing all the standard processing routines.
Routines are assumed to be in modules named p_* with * being the class name
of the routine.

All classes are added to a dictionary called modules.  If ppodd.pod.modules is
altered before a decades_dataset is created then this altered set of modules
...
def is_calmodule(mod):
    """
    Checks whether it is a calibration module, by making sure it has a 'run'
    member.
    """
    ans = False
