...
class rio_buck_cr2(cal_base):
    ...
    def __init__(self,dataset):
        ...
        self.outputs = [parameter('VMR_CR2',
                                  units='ppmv',
                                  frequency=1,
                                  number=783,
    ...
    def process(self):
        ...
        # using coefficients from the flight constants file
        ...
        tdewcr2c = flagged_data(tdew_corrected, match, flag)
